...
jQuery.fn.pagination = function(maxentries, opts) {
    ...
    return this.each(function() {
        ...
        function drawLinks() {
            ...
            if (opts.toPage) {
                var pagetext = '<input class="pagevalue" size="1" type="text">';
                var toPage = '<span><a class="search" href="javascript:;">跳转</a></span>';
                $(pagetext).appendTo(panel);
                $(toPage).appendTo(panel);
                panel.find(".search").bind("click", function(evt) {
                    var iPageNum = $.trim($(this).parent().siblings(".pagevalue").val()) - 1;
                    var re = /^-?\d+$/;
                    if (!re.test(iPageNum)) {
                        return;
                    }
